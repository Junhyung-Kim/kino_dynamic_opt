...
if(CMAKE_INSTALL_COMPONENT STREQUAL "Unspecified" OR NOT CMAKE_INSTALL_COMPONENT)
  if(EXISTS "$ENV{DESTDIR}/usr/local/lib/python3/dist-packages/pysolverlqr.cpython-38-x86_64-linux-gnu.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/lib/python3/dist-packages/pysolverlqr.cpython-38-x86_64-linux-gnu.so")
    file(RPATH_CHECK
         FILE "$ENV{DESTDIR}/usr/local/lib/python3/dist-packages/pysolverlqr.cpython-38-x86_64-linux-gnu.so"
         RPATH "/usr/local/lib:/usr/local/lib/dynamic_graph_plugins")
  endif()
  list(APPEND CMAKE_ABSOLUTE_DESTINATION_FILES
   "/usr/local/lib/python3/dist-packages/pysolverlqr.cpython-38-x86_64-linux-gnu.so")
  ...
  file(INSTALL DESTINATION "/usr/local/lib/python3/dist-packages" TYPE MODULE FILES "/home/jhk/kino_dynamic_opt/solver_lqr/build/pysolverlqr.cpython-38-x86_64-linux-gnu.so")
  if(EXISTS "$ENV{DESTDIR}/usr/local/lib/python3/dist-packages/pysolverlqr.cpython-38-x86_64-linux-gnu.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/lib/python3/dist-packages/pysolverlqr.cpython-38-x86_64-linux-gnu.so")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/lib/python3/dist-packages/pysolverlqr.cpython-38-x86_64-linux-gnu.so"
         ...
         NEW_RPATH "/usr/local/lib:/usr/local/lib/dynamic_graph_plugins")
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}/usr/local/lib/python3/dist-packages/pysolverlqr.cpython-38-x86_64-linux-gnu.so")
    endif()
  endif()
endif()
...
if(CMAKE_INSTALL_LOCAL_ONLY)
  file(WRITE "/home/jhk/kino_dynamic_opt/solver_lqr/build/install_local_manifest.txt"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
endif()

...
void init_dynamics(py::module &m)
{
  ...
  py::class_<DynamicsState>(m, "DynamicsState")
    ...
    .def_property("zmp", (const Eigen::Vector3d& (DynamicsState::*)(void) const) &DynamicsState::ZMP, (void (DynamicsState::*)(const Eigen::Vector3d&)) &DynamicsState::ZMP)
    .def_property("zmpd", (const Eigen::Vector3d& (DynamicsState::*)(void) const) &DynamicsState::ZMPd, (void (DynamicsState::*)(const Eigen::Vector3d&)) &DynamicsState::ZMPd)

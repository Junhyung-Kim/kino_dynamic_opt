...
void init_params(py::module &m)
{
  ...
  .value("PlannerDoubleParam_WeightEndOriContact_Second", PlannerDoubleParam_WeightEndOriContact_Second)
  .value("PlannerDoubleParam_WeightEndOriTracking_Second", PlannerDoubleParam_WeightEndOriTracking_Second)
  ...
  .value("PlannerDoubleParam_DGainBaseOrientationTracking_Second", PlannerDoubleParam_DGainBaseOrientationTracking_Second)
   .value("PlannerDoubleParam_PGainFOrientationTracking_Second", PlannerDoubleParam_PGainFOrientationTracking_Second)
  .value("PlannerDoubleParam_DGainFOrientationTracking_Second", PlannerDoubleParam_DGainFOrientationTracking_Second)

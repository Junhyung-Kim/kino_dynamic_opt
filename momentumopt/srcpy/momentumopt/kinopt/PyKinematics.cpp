...
void init_kinematics(py::module &m)
{
  ...
  py::class_<KinematicsState>(m, "KinematicsState")
    ...
    .def_property("rf_ori", (const Eigen::Vector3d& (KinematicsState::*)(void) const) &KinematicsState::rfOri, (void (KinematicsState::*)(const Eigen::Vector3d&)) &KinematicsState::rfOri)
    .def_property("lf_ori", (const Eigen::Vector3d& (KinematicsState::*)(void) const) &KinematicsState::lfOri, (void (KinematicsState::*)(const Eigen::Vector3d&)) &KinematicsState::lfOri)

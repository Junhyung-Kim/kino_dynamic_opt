...
planner_setting.initialize(str(PATH / 'cfg_tocabi_walk.yaml'))
...
mopt_cs_LF.append(createContactState(0, 1.0, LF_position, ContactType.FlatContact))
# after first step
#LF_position[0] = 0.3
...
planner_setting.set(mopt.PlannerVectorParam_CenterOfMassMotion, np.array([0,0.03,0]))

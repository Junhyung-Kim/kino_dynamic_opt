...
namespace momentumopt {
  ...
  PlannerDoubleParam_WeightEndOriContact_Second,
  PlannerDoubleParam_WeightEndOriTracking_Second,
  ...
  PlannerDoubleParam_PGainFOrientationTracking_Second,
  PlannerDoubleParam_DGainFOrientationTracking_Second,
  ...
  enum PlannerVectorParam {
    ...
    PlannerVectorParam_WeightdZMP,
    PlannerVectorParam_WeightZMPC,
